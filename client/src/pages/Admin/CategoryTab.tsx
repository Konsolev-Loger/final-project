...
export const CategoriesTab: React.FC<CategoriesTabProps> = ({ categories, onCreate, onUpdate, onDelete }) => {
  return (
    <>
      ...
      <div className="grid gap-4">
        {categories.map((c) => (
          <Card key={c.id} className="backdrop-blur-md bg-white/80 hover:bg-white/95 border-white/40 shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300">
